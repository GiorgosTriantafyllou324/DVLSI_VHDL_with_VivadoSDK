...
HD_PWD='C:/Users/gamin/VivadoWorkspace/FIR_filter/FIR_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_filter_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_filter_unit.tcl
