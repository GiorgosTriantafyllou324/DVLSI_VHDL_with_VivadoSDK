...
HD_PWD='C:/Users/gamin/VivadoWorkspace/FIR_filter/FIR_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_filter_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_filter_unit.tcl -notrace
