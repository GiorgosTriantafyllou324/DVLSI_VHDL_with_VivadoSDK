...
-- Date        : Tue Apr 23 23:58:36 2024
-- Host        : DESKTOP-7A5ODGC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Users/gamin/VivadoWorkspace/FIR_filter/FIR_filter.sim/sim_1/impl/func/xsim/FIR_blocks_tb_func_impl.vhd
...
entity MAC is
  port (
    y_OBUF : out STD_LOGIC_VECTOR ( 23 downto 0 );
...
begin
  CO(0) <= \^co\(0);
  y_OBUF(23 downto 0) <= \^y_obuf\(23 downto 0);
...
architecture STRUCTURE of Control_Unit is
  ...
  signal \^valid_in_filt\ : STD_LOGIC;
...
entity FIR_filter_unit is
  ...
  attribute ECO_CHECKSUM of FIR_filter_unit : entity is "dc126446";
...
MAC_Unit: entity work.MAC
     port map (
      ...
      \result[4]_i_9_0\(2) => RAM_memory_n_1,
      ...
      \result[8]_i_9_0\(0) => RAM_memory_n_13,
...
RAM_memory: entity work.RAM
     port map (
      ...
      \ram_out_reg[5]_0\(0) => RAM_memory_n_1,
...
ROM_memory: entity work.ROM
     port map (
      ...
      \multOp__0_carry__0_1\(0) => RAM_memory_n_1,
...
valid_out_OBUF_inst: unisim.vcomponents.OBUFT
     port map (
      I => '0',
      O => valid_out,
      T => '1'
