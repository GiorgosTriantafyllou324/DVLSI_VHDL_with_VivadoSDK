...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_depth_reg is
  signal \DataInternal_reg_n_0_[9]\ : STD_LOGIC;
...
reg0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_depth_reg
     port map (
      \DataInternal_reg[0]_0\(0) => p_0_out(0),
      Q(0) => slv_reg1(8),
      s00_axi_aclk => s00_axi_aclk,
      slv_reg1(0) => slv_reg1(0)
    );
rst_new: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
