...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Control_Unit is
  port (
    ...
    \ram_out_reg[7]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    result0 : in STD_LOGIC_VECTOR ( 11 downto 0 );
    \ram_out_reg[7]_0\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Control_Unit is
  ...
  attribute SOFT_HLUTNM of \ram[0][7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ram_out[7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \result[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \result[15]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \result[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \result[7]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \result[8]_i_1\ : label is "soft_lutpair6";
...
CU: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Control_Unit
     port map (
      ...
      \count_reg[1]_0\(0) => CU_n_35,
      \ram_in_reg[7]\(7) => CU_n_24,
      \ram_in_reg[7]\(6) => CU_n_25,
      \ram_in_reg[7]\(5) => CU_n_26,
      \ram_in_reg[7]\(4) => CU_n_27,
      \ram_in_reg[7]\(3) => CU_n_28,
      \ram_in_reg[7]\(2) => CU_n_29,
      \ram_in_reg[7]\(1) => CU_n_30,
      \ram_in_reg[7]\(0) => CU_n_31,
      \ram_out_reg[0]\ => RAM_memory_n_31,
      \ram_out_reg[0]_0\ => RAM_memory_n_30,
      \ram_out_reg[1]\ => RAM_memory_n_29,
      \ram_out_reg[1]_0\ => RAM_memory_n_28,
      \ram_out_reg[2]\ => RAM_memory_n_27,
      \ram_out_reg[2]_0\ => RAM_memory_n_26,
      \ram_out_reg[3]\ => RAM_memory_n_25,
      \ram_out_reg[3]_0\ => RAM_memory_n_24,
      \ram_out_reg[4]\ => RAM_memory_n_23,
      \ram_out_reg[4]_0\ => RAM_memory_n_22,
      \ram_out_reg[5]\ => RAM_memory_n_21,
      \ram_out_reg[5]_0\ => RAM_memory_n_20,
      \ram_out_reg[6]\ => RAM_memory_n_19,
      \ram_out_reg[6]_0\ => RAM_memory_n_18,
      \ram_out_reg[7]\(0) => Q(8),
      \ram_out_reg[7]_0\(7 downto 0) => ram_in(7 downto 0),
      \ram_out_reg[7]_1\ => RAM_memory_n_17,
      \ram_out_reg[7]_2\ => RAM_memory_n_16,
      result0(11 downto 0) => result0(11 downto 0),
      result00_out(19 downto 12) => result00_out(23 downto 16),
      result00_out(11 downto 0) => result00_out(11 downto 0),
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
      s00_axi_aresetn_0 => CU_n_0
    );
MAC_Unit: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MAC
     port map (
      ...
      result0(11 downto 0) => result0(11 downto 0),
      \result_reg[11]_0\(2) => RAM_memory_n_15,
      ...
      \result_reg[23]_1\(19) => CU_n_3,
      \result_reg[23]_1\(18) => CU_n_4,
      \result_reg[23]_1\(17) => CU_n_5,
      \result_reg[23]_1\(16) => CU_n_6,
      \result_reg[23]_1\(15) => CU_n_7,
      \result_reg[23]_1\(14) => CU_n_8,
      \result_reg[23]_1\(13) => CU_n_9,
      \result_reg[23]_1\(12) => CU_n_10,
      \result_reg[23]_1\(11) => CU_n_11,
      \result_reg[23]_1\(10) => CU_n_12,
      \result_reg[23]_1\(9) => CU_n_13,
      \result_reg[23]_1\(8) => CU_n_14,
      \result_reg[23]_1\(7) => CU_n_15,
      \result_reg[23]_1\(6) => CU_n_16,
      \result_reg[23]_1\(5) => CU_n_17,
      \result_reg[23]_1\(4) => CU_n_18,
      \result_reg[23]_1\(3) => CU_n_19,
      \result_reg[23]_1\(2) => CU_n_20,
      \result_reg[23]_1\(1) => CU_n_21,
      \result_reg[23]_1\(0) => CU_n_22,
      ...
      \result_reg[7]_1\(0) => RAM_memory_n_32,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn
    );
RAM_memory: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RAM
     port map (
      ...
      \ram_out_reg[6]_0\ => RAM_memory_n_14,
      \ram_out_reg[7]_0\(0) => RAM_memory_n_15,
      ...
      \ram_reg[3][2]_0\ => RAM_memory_n_26,
      \ram_reg[3][3]_0\ => RAM_memory_n_24,
      \ram_reg[3][4]_0\ => RAM_memory_n_22,
      \ram_reg[3][5]_0\ => RAM_memory_n_20,
      \ram_reg[3][6]_0\ => RAM_memory_n_18,
      \ram_reg[3][7]_0\ => RAM_memory_n_16,
      \ram_reg[7][0]_0\ => RAM_memory_n_31,
      \ram_reg[7][1]_0\ => RAM_memory_n_29,
      \ram_reg[7][2]_0\ => RAM_memory_n_27,
      \ram_reg[7][3]_0\ => RAM_memory_n_25,
      \ram_reg[7][4]_0\ => RAM_memory_n_23,
      \ram_reg[7][5]_0\ => RAM_memory_n_21,
      \ram_reg[7][6]_0\ => RAM_memory_n_19,
      \ram_reg[7][7]_0\ => RAM_memory_n_17,
      \result0__0_carry__0\ => ROM_memory_n_7,
      \result0__0_carry__1\(3 downto 0) => rom_out(3 downto 0),
      \rom_out_reg[1]\(0) => RAM_memory_n_32,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn
    );
ROM_memory: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ROM
     port map (
      ...
      \result0__0_carry__1_0\ => RAM_memory_n_14,
