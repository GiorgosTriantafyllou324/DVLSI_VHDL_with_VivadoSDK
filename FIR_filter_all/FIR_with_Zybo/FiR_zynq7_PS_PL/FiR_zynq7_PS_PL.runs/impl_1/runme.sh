...
HD_PWD='C:/Users/gamin/VivadoWorkspace/FIR_with_Zybo/FiR_zynq7_PS_PL/FiR_zynq7_PS_PL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_design_1_wrapper.tcl -notrace
